...
model = dict(
    ...
    # camera
    img_backbone=dict(
        # pretrained='/home/ken/program/model/mmd/BEVDet/tools/resnet15_121_pretrain_mod.pth',
        pretrained=None,
        # pretrained='/home/ken/program/model/mmd/BEVDet/work_dirs/dvtfusion_tiny_res28/epoch_1.pth',
        type='ResNet',
        depth=18,
        num_stages=3,
        strides=(1,1,2),
        ...
        style='pytorch'),
    img_neck=dict(
        type='ASPPNeck',# modified on 20240919 for light-weight
        in_channels=256,out_channels=128),
        # in_channels=512,out_channels=128,pre_conv=256),
    img_view_transformer=dict(
        # type='LSSViewTransformer_Sparse_with_ATT',
        type='LSSViewTransformer_Pillar_Sparse_with_ATT',
        grid_config=grid_config,
        input_size=data_config['input_size_1'],
    ...
    pts_bbox_head=dict(
        ...
        loss_bbox=dict(type='L1Loss', reduction='mean', loss_weight=0.25)),# modified by zhuo on 20241012
